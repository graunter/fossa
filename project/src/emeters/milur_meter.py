...
class MilurMeter:
    ...
    trans_str_tbl = { 
        ...
        , ReqId.ActPwr: Msg("Total Active power", "Total P", "W",   DType.DigitData, mconst.AP_ALL_ID_DATA, 4, 1000)   
        ...
        , ReqId.ReActPwr: Msg("Total ReActive power", "Total Q", "var", DType.DigitData, mconst.RP_ALL_ID_DATA, 4, 1000)   

        , ReqId.Active_imp_e: Msg("Active in energy sum", "AP", "W*h", DType.PacDecData, mconst.AP_ID_DATA, 4, 0)  
        , ReqId.Active_imp_e_1: Msg("Active in energy sum", "AP-t1", "W*h", DType.PacDecData, mconst.AP_T1_ID_DATA, 4, 0)  
        , ReqId.Active_imp_e_2: Msg("Active in energy sum", "AP-t2", "W*h", DType.PacDecData, mconst.AP_T2_ID_DATA, 4, 0)  
        , ReqId.Active_imp_e_3: Msg("Active in energy sum", "AP-t3", "W*h", DType.PacDecData, mconst.AP_T3_ID_DATA, 4, 0)  
        , ReqId.Active_imp_e_4: Msg("Active in energy sum", "AP-t4", "W*h", DType.PacDecData, mconst.AP_T4_ID_DATA, 4, 0)  
        , ReqId.Active_imp_e_5: Msg("Active in energy sum", "AP-t5", "W*h", DType.PacDecData, mconst.AP_T5_ID_DATA, 4, 0)  
        , ReqId.Active_imp_e_6: Msg("Active in energy sum", "AP-t6", "W*h", DType.PacDecData, mconst.AP_T6_ID_DATA, 4, 0)  
        , ReqId.Active_imp_e_7: Msg("Active in energy sum", "AP-t7", "W*h", DType.PacDecData, mconst.AP_T7_ID_DATA, 4, 0)  
        , ReqId.Active_imp_e_8: Msg("Active in energy sum", "AP-t8", "W*h", DType.PacDecData, mconst.AP_T8_ID_DATA, 4, 0)        

        , ReqId.ReAct_imp_e: Msg("ReActive in energy sum", "RP", "W*h", DType.PacDecData, mconst.RP_ID_DATA, 4, 0)                    
        , ReqId.ReAct_imp_e_1: Msg("ReActive in energy sum", "RP-t1", "W*h", DType.PacDecData, mconst.RP_T1_ID_DATA, 4, 0)          
        , ReqId.ReAct_imp_e_2: Msg("ReActive in energy sum", "RP-t2", "W*h", DType.PacDecData, mconst.RP_T2_ID_DATA, 4, 0)  
        , ReqId.ReAct_imp_e_3: Msg("ReActive in energy sum", "RP-t3", "W*h", DType.PacDecData, mconst.RP_T3_ID_DATA, 4, 0)  
        , ReqId.ReAct_imp_e_4: Msg("ReActive in energy sum", "RP-t4", "W*h", DType.PacDecData, mconst.RP_T4_ID_DATA, 4, 0)   
        , ReqId.ReAct_imp_e_5: Msg("ReActive in energy sum", "RP-t5", "W*h", DType.PacDecData, mconst.RP_T5_ID_DATA, 4, 0)          
        , ReqId.ReAct_imp_e_6: Msg("ReActive in energy sum", "RP-t6", "W*h", DType.PacDecData, mconst.RP_T6_ID_DATA, 4, 0)  
        , ReqId.ReAct_imp_e_7: Msg("ReActive in energy sum", "RP-t7", "W*h", DType.PacDecData, mconst.RP_T7_ID_DATA, 4, 0)  
        , ReqId.ReAct_imp_e_8: Msg("ReActive in energy sum", "RP-t8", "W*h", DType.PacDecData, mconst.RP_T8_ID_DATA, 4, 0)     

        , ReqId.Active_exp_e: Msg("Active out energy sum", "AN", "W*h", DType.PacDecData, mconst.AN_ID_DATA, 4, 0)  
        , ReqId.Active_exp_e_1: Msg("Active out energy sum", "AN-t1", "W*h", DType.PacDecData, mconst.AN_T1_ID_DATA, 4, 0)  
        , ReqId.Active_exp_e_2: Msg("Active out energy sum", "AN-t2", "W*h", DType.PacDecData, mconst.AN_T2_ID_DATA, 4, 0)  
        , ReqId.Active_exp_e_3: Msg("Active out energy sum", "AN-t3", "W*h", DType.PacDecData, mconst.AN_T3_ID_DATA, 4, 0)  
        , ReqId.Active_exp_e_4: Msg("Active out energy sum", "AN-t4", "W*h", DType.PacDecData, mconst.AN_T4_ID_DATA, 4, 0)  
        , ReqId.Active_exp_e_5: Msg("Active out energy sum", "AN-t5", "W*h", DType.PacDecData, mconst.AN_T5_ID_DATA, 4, 0)  
        , ReqId.Active_exp_e_6: Msg("Active out energy sum", "AN-t6", "W*h", DType.PacDecData, mconst.AN_T6_ID_DATA, 4, 0)  
        , ReqId.Active_exp_e_7: Msg("Active out energy sum", "AN-t7", "W*h", DType.PacDecData, mconst.AN_T7_ID_DATA, 4, 0)  
        , ReqId.Active_exp_e_8: Msg("Active out energy sum", "AN-t8", "W*h", DType.PacDecData, mconst.AN_T8_ID_DATA, 4, 0)        

        , ReqId.ReAct_exp_e: Msg("ReActive out energy sum", "RN", "W*h", DType.PacDecData, mconst.RN_ID_DATA, 4, 0)                    
        , ReqId.ReAct_exp_e_1: Msg("ReActive out energy sum", "RN-t1", "W*h", DType.PacDecData, mconst.RN_T1_ID_DATA, 4, 0)          
        , ReqId.ReAct_exp_e_2: Msg("ReActive out energy sum", "RN-t2", "W*h", DType.PacDecData, mconst.RN_T2_ID_DATA, 4, 0)  
        , ReqId.ReAct_exp_e_3: Msg("ReActive out energy sum", "RN-t3", "W*h", DType.PacDecData, mconst.RN_T3_ID_DATA, 4, 0)  
        , ReqId.ReAct_exp_e_4: Msg("ReActive out energy sum", "RN-t4", "W*h", DType.PacDecData, mconst.RN_T4_ID_DATA, 4, 0)   
        , ReqId.ReAct_exp_e_5: Msg("ReActive out energy sum", "RN-t5", "W*h", DType.PacDecData, mconst.RN_T5_ID_DATA, 4, 0)          
        , ReqId.ReAct_exp_e_6: Msg("ReActive out energy sum", "RN-t6", "W*h", DType.PacDecData, mconst.RN_T6_ID_DATA, 4, 0)  
        , ReqId.ReAct_exp_e_7: Msg("ReActive out energy sum", "RN-t7", "W*h", DType.PacDecData, mconst.RN_T7_ID_DATA, 4, 0)  
        , ReqId.ReAct_exp_e_8: Msg("ReActive out energy sum", "RN-t8", "W*h", DType.PacDecData, mconst.RN_T8_ID_DATA, 4, 0)                                     
    }
